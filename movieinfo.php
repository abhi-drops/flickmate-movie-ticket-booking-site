...
#myVideo {
  ...
  <body>
    ...
    <div class="container-fluid m-0 p-0" >
      ...
      <div class="youtube-container" style="background: rgb(255, 255, 255);">
      <?php
        echo"
        
        <iframe width='100%' height='400px' src='$mtlink'  title='YouTube video player' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>
      ...
      <div style="border-radius: 0px;" class="  card m-0 p-2 pt-4 ">
        <div class="d-flex justify-content-start">

          <a href='/flickmate/kl.php'>
            <?php

              echo"
              
              <img class='thum m-1' src='$mpos' height= '297 px' width='210 px' >
          ...
          <?php
              ...
              <div class='card-body row '>
                      <h5 class='card-title col-md-12'>$row[mname]</h5>
                       <p class='card-text col-md-12'><small class='text-muted'>$row[mlang]</small></p>
                      ...
                      <div class='col-md-8 my-5 d-flex justify-content-end'>
                        <a href='/flickmate/selecttime.php?mid=$row[mid].php' role='button'  class='btn btn-outline-danger' >Book Now</a>
                      </div>
