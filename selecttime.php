...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
  ...
  do{
      ...
      $successMessage = "client updated correctly";
          ...
          header("location:/flickmate/seatselect.php?mid=$mid&bdate=$bdate&btime=$btime");
          exit;
                ...
                <div class="d-flex justify-content-center mx-5 mt-5 ">
                  <form action="" method="POST">
                      <div class="m-5">
                            ...
                            <input type="date" name="bdate" class="form-control" id="date"  min="<?php echo $msd ?>" max="<?php echo $med ?>" required>
                        </div>
